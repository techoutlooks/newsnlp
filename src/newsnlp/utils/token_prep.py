...
class TokenPrep:
    ...
    def to_python(self, corpus: Iterable[Doc]) -> Iterable[list]:
        """
        Serialize corpus into a list of sentences, each split into bare word strings.
...
class TokenNormalizer:
    ...
    def __call__(self, doc: Doc) -> Doc:
        ...
        compose = lambda f1, f2: lambda t: f2(f1(t))
        ...
        new_doc = Doc(
            vocab=doc.vocab,
            words=[compose(lemmatizer, to_lowercase)(t)
